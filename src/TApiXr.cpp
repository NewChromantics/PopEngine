...
void ApiXr::TSessionWrapper::Construct(Bind::TCallback& Params)
{
#if defined(TARGET_IOS)
	mSession.reset( new ArkitSession() );
#else
	Soy_AssertTodo();
#endif
}

void ApiOpenvr::TSessionWrapper::CreateTemplate(Bind::TTemplate& Template)
{
	Template.BindFunction<BindFunction::WaitForPoses>(&TPoseWrapper::WaitForPoses);
